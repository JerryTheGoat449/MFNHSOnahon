document.addEventListener("DOMContentLoaded", () => {
  ...
  function hideAllSections() {
    ...
    buttons.forEach((button) => {
      button.style.backgroundColor = "#8B4513"; // Set brown background color
      button.style.color = "white"; // Set text color to white for contrast
      button.style.border = "2px solid #3E1F10"; // Darker brown border for buttons
    });
  }
  ...
  function styleButton(button) {
    ...
    button.style.border = "2px solid #3E1F10"; // Dark brown border for buttons
    button.style.padding = "10px 20px";
    button.style.margin = "10px";
    button.style.borderRadius = "5px"; // Rounded corners for modern look
  ...
  function createButton(button, label, section) {
    ...
    button.addEventListener("click", () => {
      ...
      button.style.backgroundColor = "#D2B48C"; // Light brown (match section background)
      button.style.border = "2px solid #3E1F10"; // Dark brown border (match section border)
    });
